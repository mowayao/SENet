...
class ResBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1):
        ...
        self.linear1 = nn.Linear(planes * 4, planes / 4)
        self.linear2 = nn.Linear(planes / 4, planes * 4)
...
class SEBlock(nn.Module):
    def __init__(self, planes, r=16):
        ...
        self.adap_pool = nn.AdaptiveAvgPool2d(1)
        self.linear1 = nn.Linear(planes*4, planes*4/r)
        self.linear2 = nn.Linear(planes*4/r, planes*4)
        self.sigmoid = nn.Sigmoid()
        self.relu = nn.ReLU()
    def forward(self, x):
        se = x
